...
FSU_custom_allclasses = ['Dome', 'Dome_Base', 'Dome2', 'Dome2_Base', 'Dome2_Bottom', 
                        'Cone', 'Cone_Base', 'Square', 'Square_Base', 'SquareShade', 
                        'SquareShade_Base', 'Triangle', 'Penta', 'Penta_Base', 'Hexa', 
                        'Hexa_Base', 'Mini', 'Mini_Base', 'Mini_Hinge', 'Mini_Shade', 
                        'Cylinder', 'Cylinder_Base', 'PTZ', 'Mic', "real_dome", 
                        "real_dome2", "real_squareshade", "real_hexa", "real_mini", 
                        "real_cylinder"]


FSU_custom_baseclasses = ['Dome', 'Dome_Base', 'Dome2', 'Dome2_Base', 'Dome2_Bottom', 
                        'Cone', 'Cone_Base', 'Square', 'Square_Base', 'SquareShade', 
                        'SquareShade_Base', 'Triangle', 'Penta', 'Penta_Base', 'Hexa', 
                        'Hexa_Base', 'Mini', 'Mini_Base', 'Mini_Hinge', 'Mini_Shade', 
                        'Cylinder', 'Cylinder_Base', 'PTZ', 'Mic']
    

FSU_custom_novelclasses = ["real_dome", "real_dome2", "real_squareshade", "real_hexa", 
                        "real_mini", "real_cylinder"] 

def _get_fsucustom_fewshot_instances_meta():

    metadata = {
        "thing_clases": FSU_custom_allclasses,
        "base_classes": FSU_custom_baseclasses,
        "novel_classes": FSU_custom_novelclasses,
    }
    return metadata
...
def _get_builtin_metadata(dataset_name):
    ...
    elif dataset_name == 'fsucustom_fewshot':
        return _get_fsucustom_fewshot_instances_meta()
