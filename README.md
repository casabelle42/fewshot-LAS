...
# Calling demo (test)
```
python3 -m demo.demo --config-file configs/fsu/all_1shot.yaml --input input1.jpg --output= save --opts MODEL.WEIGHTS checkpoints/coco/faster_rcnn/t1_faster_rcnn_R_101_FPN_final 
```
